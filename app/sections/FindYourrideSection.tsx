...
//   if(error) {
//     return <div className="text-red-500">Error loading cars</div>;
//   }
    ...
    >
      ...
      <div className="relative z-10 max-w-[1320px] mx-auto px-6 md:px-12 lg:px-20 py-24 lg:py-32">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-16">
          ...
          <div className="flex items-center flex-col gap-4 self-end">
           <motion.a
  href="/fleet"
  initial={{ opacity: 0, x: 30 }}
  whileInView={{ opacity: 1, x: 0 }}
...
<motion.a
          ...
          transition={{ duration: 0.75, delay: 0.12 }}
          whileTap={{ scale: 0.97 }}
          className="md:hidden w-full inline-flex items-center justify-center mt-4 gap-2.5 px-8 py-3 text-[9.5px] font-bold tracking-[0.3em] uppercase no-underline"
          style={{
            background: "linear-gradient(135deg, #8B7035 0%, #C9A84C 100%)",
            color: "#000",
          }}
          ...
          {cars.length > 3 && (
            ...
            >
              <button
                ...
                className="w-12 h-12 flex items-center justify-center border transition-all duration-300 hover:border-[#C9A84C] group"
                style={{ border: "1px solid rgba(201,168,76,0.3)" }}
                aria-label="Previous slide"
              >
                <span className="rotate-180 group-hover:text-[#C9A84C] transition-colors">
                  <IconArrow />
                </span>
              </button>
              <button
                ref={navigationNextRef}
                className="w-12 h-12 flex items-center justify-center border transition-all duration-300 hover:bg-[#C9A84C] hover:border-[#C9A84C] group"
                style={{ border: "1px solid rgba(201,168,76,0.3)" }}
        ...
        {/* Custom Pagination */}
        {cars.length > 3 && (
          <div className="swiper-pagination mb-16 flex justify-center gap-2 "></div>
        )}
